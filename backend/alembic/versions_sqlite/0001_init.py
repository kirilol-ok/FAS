...
def upgrade() -> None:
    ...
    with op.batch_alter_table("Admins") as batch_op:
        batch_op.create_index(
            batch_op.f("ix_Admins_first_name"), ["first_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_Admins_last_name"), ["last_name"], unique=False
        )
        batch_op.create_index(batch_op.f("ix_Admins_email"), ["email"], unique=True)
        batch_op.create_index(
            batch_op.f("ix_Admins_qr_value"), ["qr_value"], unique=True
        )
    ...
    with op.batch_alter_table("Employees") as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_Employees_qr_value"), ["qr_value"], unique=True
        )
    ...
    with op.batch_alter_table("Reports") as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_Reports_employee_id"), ["employee_id"], unique=False
        )
